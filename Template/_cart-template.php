        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row border-top py-3 mt-3">
                    <div class="col-sm-2">
                        <img src="<?php echo $item['item_image'] ?? "./assets/products/2.png"; ?>" style="height: 120px;" alt="cart2" class="img-fluid">
                    </div>
                    <div class="col-sm-8">
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    <h6 class="font-size-12 font-rale text-success py-3"><i class="fas fa-check">Your order is eligable for FREE Delivery</i></h6>
