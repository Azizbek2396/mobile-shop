        ...
        <div class="row">
            <div class="col-lg-3 col-12">
                ...
                <p class="font-size-14 font-rale text-white-50">
                    ...
                    voluptatem exercitationem veritatis. Deserunt praesentium sed
                    sequi.
                </p>
            </div>
...
<div class="copyright text-center bg-dark text-white py-2">
    <p class="font-rale font-size-14">&copy; Copyright 2020. Desing by <a href="#" class="color-second">Mister Aziz</a></p>
</div>
<!-- !start #footer -->
